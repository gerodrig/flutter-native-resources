...
class PermissionsNotifier extends StateNotifier<PermissionsState> {
  ...
  void _checkPermissionSate(PermissionStatus status) {
  ...
  requestCameraAccess() async {
    ...
    state = state._copyWith(camera: status);

    _checkPermissionSate(status);
  }

  requestGalleryAccess() async {
    final status = await Permission.mediaLibrary.request();
    state = state._copyWith(photoLibrary: status);
  ...
  requestLocationAccess() async {
    ...
    state = state._copyWith(location: status);
  ...
  requestSensorsAccess() async {
    ...
    state = state._copyWith(sensors: status);
