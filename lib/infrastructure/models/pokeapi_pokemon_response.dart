...
PokeApiPokemonResponse pokeApiPokemonResponseFromJson(String str) =>
    PokeApiPokemonResponse.fromJson(json.decode(str));

String pokeApiPokemonResponseToJson(PokeApiPokemonResponse data) =>
